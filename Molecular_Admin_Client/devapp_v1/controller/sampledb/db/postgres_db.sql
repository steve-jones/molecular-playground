...
create table students (id varchar(25),password varchar(25),firstname varchar(50),lastname varchar(50),year level,schoolorg varchar(100),gpa decimal,trackid varchar(50),primary key (id));

create table admins (id varchar(16),password varchar(25),firstname varchar(50),lastname varchar(50),isadminfor varchar(50));

create table coursecatalog (coursenumber varchar(20),coursename varchar(100),credits int,semestersoffered offered,instructor varchar(50),primary key (coursenumber));

create table prerequisites (coursenumber varchar(6),prereq varchar(6));

create table studentschedule (studentid varchar(25),coursenumber varchar(25),term varchar(20),instructor varchar(50));
